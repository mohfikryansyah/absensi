        ...
        <nav
            ...
            <div class="flex items-center justify-between">
                ...
                <a class="flex-none rounded-md text-xl inline-block font-semibold focus:outline-none focus:opacity-80"
                    href="../examples/html/scrollspy-onepage-menu.html" aria-label="Preline">
            ...
            <div id="hs-header-scrollspy"
                ...
                <div
                    ...
                    <div data-hs-scrollspy="#scrollspy"
                        ...
                        <a class="p-2 flex items-center text-sm text-gray-800 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 dark:bg-neutral-700 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 hs-scrollspy-active:bg-transparent dark:hs-scrollspy-active:bg-neutral-700"
                            href="#landing">
